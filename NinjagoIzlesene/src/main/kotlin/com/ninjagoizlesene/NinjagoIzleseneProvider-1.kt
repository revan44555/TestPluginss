...
class NinjagoIzleseneProvider : MainAPI() {
    ...
    override suspend fun loadLinks(
        ...
        // Sezon 1-10: sadece Google Drive kaynağı kullanılır. Drive'da bölüm
        // yoksa siteye hiç düşülmez, direkt "bulunamadı" ile sonuçlanır.
        // Sezon 11+: Drive'a hiç bakılmaz, direkt site akışına (Dzen, YouTube vb.) geçilir.
        run {
            ...
            // teslim başarısız olduysa) siteye HİÇ düşülmez.
            ...
            Regex(
                ...
                .forEach { embedUrl ->
                    runCatching {
                        ...
                        Log.d("NinjagoIzlesene", "Gömülü YouTube linki başarısız ($embedUrl): ${it.message}")
                    }
                }
            Regex(
