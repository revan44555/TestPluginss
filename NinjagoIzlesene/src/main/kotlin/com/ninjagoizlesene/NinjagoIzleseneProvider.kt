...
class NinjagoIzleseneProvider : MainAPI() {
    ...
    // Site bot korumasına sahip olabilir (403 dönebilir), bu yüzden
    // tüm isteklerde gerçek bir tarayıcı gibi görünen header'lar kullanıyoruz.
    ...
    override suspend fun search(query: String): List<SearchResponse> {
        val doc = app.get("$mainUrl/dizi-arsivi/", headers = headers).document
