...
class NinjagoIzleseneProvider : MainAPI() {
    ...
    private suspend fun resolveDzenEmbed(
        ...
        // 1) Doğrudan .m3u8 adresleri (genelde birden fazla kalite/CDN
        //    varyantı olabilir; hepsini gönderiyoruz, CloudStream player
        //    içinde kalite seçimini kendisi sunar).
