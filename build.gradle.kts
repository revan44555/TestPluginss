...
subprojects {
    ...
    dependencies {
        ...
        // CloudStream currently uses NewPipeExtractor 0.26.3 transitively.
        // Pin 0.26.4 for the plugin so the YouTube extractor receives the latest
        // NewPipe fixes available to this project.
